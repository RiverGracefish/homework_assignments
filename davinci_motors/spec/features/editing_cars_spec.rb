# Add a test for editing the car
...
# This will require a feature test, as well as controller and view changes/additions
# Are we learning to like TDD yet?
# I can use more practice.
